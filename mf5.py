...
root.iconbitmap("C:\\Users\\shiro\\OneDrive\\Desktop\\icon.ico")
root.minsize(600, 270)
root.maxsize(600, 270)

image = Image.open("C:\\Users\\shiro\\OneDrive\\Desktop\\currency.png")
zoom = 0.5
...
def show_data():
    ...
    to_currency = c2.get()
    url = "http://api.currencylayer.com/live?access_key=ff039d7bb723e9e279693a14ae274642&format=1"
